...
from data.constant import culane_row_anchor, tusimple_row_anchor, LindenLane_row_anchor, bismarck_row_anchor
...
if __name__ == "__main__":
    ...
    img_transforms_linden = transforms.Compose([
    ...
    for split, dataset in zip(splits, datasets):
        ...
        for i, data in enumerate(tqdm.tqdm(loader)):
            ...
            #was col_sample = np.linspace(0, 800 - 1, cfg.griding_num)
            col_sample = np.linspace(0, 224 - 1, cfg.griding_num)
